...
function calculate2() {
    ...
    console.log("Matrix Type Chk:")
    console.log("\tMatrix = \n\t"+tw_matrix_chk);
    console.log("\tTransposed = \n\t"+tw_transpose_matrix_chk);
    console.log("-----")
    ...
    // to find the inverse of eigen vectors
    var tw_ev_x1 = twv1[1];
    var tw_ev_x2 = twv2[1]; 

    // Eigen vectors of 2x2
    // x1 = |a11| x2 = |b11|
    //      |a21|      |b21|
    ...
    // this line of code  does exactly what is given above :)
    var mat_b = [[tw_ev_x1[0], tw_ev_x2[0]], [tw_ev_x1[1], tw_ev_x2[1]]];
    var inv_mat_b = math.inv(mat_b);
    var diagonalised_mat = math.multiply(inv_mat_b, tw_matrix, mat_b)
    ...
    if (dia_ns == 0) { //symmetric
        ...
        var dia_matr1_a1 = [dia_matr1_a11, dia_matr1_a12];
